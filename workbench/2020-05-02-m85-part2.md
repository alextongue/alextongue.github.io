...
- The culprit is either:
  - (1) elsewhere on the main board, or
  - (2) on the long auxiliary "daughterboards." I hope it's the main board, because it looks like a pain to access the daughterboards -- people just desolder the auxiliary power transistors altogether to remove the boards, then and resolder them after repair.
...
<figure>
    ...
    <figcaption>Notice the solder joints with black near the center of the photo. It's probably just hardened flux (see the right side of the photo, where the big joints are), although it is a worrying possibility that the PCB was burning up at those points. Regardless, those points were connected to a large 5W resistor on the other side, and it looked (and measured) perfectly fine.</figcaption>
</figure>
