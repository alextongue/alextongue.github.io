...
> **Question:** We can see that choosing of $t_1<1$ is in effect, identical as choosing $t_1\geq 9$: both ranges classify all of the values into one bin and leave the other bin empty. There doesn't seem to be any strict symmetry in boundaries otherwise (e.g. $t_1=1.5$ and $t_1=8.$$ do not result in the same sets). Is this an issue?
> 
...
- **Step 1:** Choose a decision boundary $t_1$
